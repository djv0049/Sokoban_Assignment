...
class TestLevel {
	...
	@Test void testLevelWidth() {
	 assertEquals(6, level.getWidth());
	}
	@Test void testLevelHeight() {
	 assertEquals(5, level.getHeight());
	}
	@Test void testLevelMoveCount() {
	 assertEquals(0, level.getMoveCount());
	}

	@Test void testLevelName() {
	 assertEquals("Level1", level.getName());
	}
	@Test void testLevelCompletedCount() {
	 assertEquals(0, level.getCompletedCount());
	}
	@Test void testLevelTargetCount() {
