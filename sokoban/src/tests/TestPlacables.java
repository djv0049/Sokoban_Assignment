...
class TestPlacables {
	...
	@Test void testEmptySymbol() {
		 ...
		 @Test void testCrateOnTargetSymbol() {
		  Target target = new Target(1, 1);
		 ...
		 @Test void testWorkerOnEmptySymbol() {
		 ...
		 @Test void testCrateOnEmptySymbol() {
		  Empty empty = new Empty(1, 1);
		  Crate crate = new Crate(1, 1);
